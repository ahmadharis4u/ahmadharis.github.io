...
#define SDP_MEDIA_CHECK_ERROR 1188

#define SDP_RECEIVER_ERROR 1190
#define SDP_RECEIVER_SOCKET_ERROR 1191
#define SDP_RECEIVER_CONNECT_ERROR 1192
#define SDP_RECEIVER_MESSAGE_ERROR 1193
...
#define SDP_PORT_ERROR 1320
#define SDP_IP_ERROR 1330
...
#define ARGC 4
#define INIT '\0'
#define CLIENT_CONFIG_FILE "cl_config"
...
extern return_type sdp_client_sender(char *, int *);
extern char *sdp_client_recvr(char *[], int *);
extern return_type sdp_media_comp(char *, char *);
